...
def worker(start_date,end_date,event_name):
    ...
    with open(f'data-{start_date}-{end_date}-ahmet.csv', 'a+', encoding='UTF8', newline='') as f:
...
worker("2022-09-01","2022-09-01","account_deleted_info") #TODO: burayı dışardan argüman alacak şekilde düzenle
